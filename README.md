...
| Allocator/build profile | System allocator by default, explicit `jemalloc` benchmark builds, speed-oriented release profile, strict artifact validation for perf claims | Keeps shipping builds portable while preserving allocator experiments and claim integrity |
